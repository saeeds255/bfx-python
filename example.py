...
zoneh = buysig * (1 + percent_profit/100)
sellsig = buysig - (zoneh - buysig)/3
zonel = sellsig - (zoneh - buysig)
q1 = base_amount
q2 = base_amount * 1.4
q2exit = q2 - q1
q3 = base_amount * 1.4 * 1.4
q3exit = q3 - q2
q4 = base_amount * 1.4 * 1.4 * 1.4
q4exit = q4 - q3
q5 = base_amount * 1.4 * 1.4 * 1.4 * 1.4
q5exit = q5 - q4
q6 = base_amount * 1.4 * 1.4 * 1.4 * 1.4 * 1.4
q6exit = q6 - q5
q7 = base_amount * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4
q7exit = q7 - q6
q8 = base_amount * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4
q8exit = q8 - q7
q9 = base_amount * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4 * 1.4
q9exit = q9 - q8
...
while (market_price < zoneh || market_price > sellsig):
  time.sleep(1)
  market_price = float(price['last_price'])
...
while (market_price > zonel || market_price < buysig):
  time.sleep(1)
  market_price = float(price['last_price'])
